		...
		<div class="wrapper">
			<div class="container" id="main">
				...
				<article id="content">
					<header>
						<h2>Camille MARCQ</h2>
						<p>Etre psy, c'est ma vie !</p>
					</header>
					<div class="row">
						<section class="3u 6u(narrower)">
							<a href="#" class="image featured"><img src="../images/avatar.png"
								alt="C.MARCQ" /></a>
						</section>
						<section class="9u 12u(narrower)">
							<p align="justify">Ut sed tortor luctus, gravida nibh eget, volutpat odio. Proin
								...
								urna ac consectetur.</p>
							<p align="justify">Mauris eleifend eleifend felis aliquet ornare. Vestibulum
								porta velit at elementum gravida nibh eget, volutpat odio. Proin
								rhoncus, sapien mollis luctus hendrerit, orci dui viverra metus,
								et cursus nulla mi sed elit. Vestibulum condimentum, mauris a
								mattis vestibulum, urna mauris cursus lorem, eu fringilla lacus
								ante non est. Nullam vitae feugiat libero, eu consequat sem.
								...
								Praesent mollis nisi at vestibulum aliquet. Sed sagittis congue
								urna ac consectetur.</p>
							<p align="justify">Vestibulum pellentesque posuere lorem non aliquam. Mauris
